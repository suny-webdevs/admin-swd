          ...
          <CardContent className="space-y-10">
            ...
            <div className="space-y-1">
              ...
              <p className="text-lg tracking-wide">
                ...
                seamless user experiences, integrating APIs, and managing
                databases to deliver high-performance, scalable web
                applications.
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="text-lg tracking-wide">
                <p>
                  <strong>Front-End :</strong> Building intuitive, responsive,
                  and user-friendly web interfaces with clean and efficient
                  code.
                </p>
                <p>
                  <strong>Back-End :</strong> Building intuitive, responsive,
                  and user-friendly web interfaces with clean and efficient
                  code.
                </p>
                <p>
                  <strong>Full Stack :</strong> Building intuitive, responsive,
                  and user-friendly web interfaces with clean and efficient
                  code.
                </p>
              </div>
